...
if (isset($result) && $result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        if (
            $row['event_enddate'] != "0000-00-00" && $row['event_enddate'] != $row['event_startdate']
        ...
        // $row['event_url'] = "form_calendar.php?id=" . $row['event_id'];
        $row['event_url'] = "javascript:viewdetail('{$row['event_id']}');";
