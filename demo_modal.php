...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" id="calendarmodal-detail"> ก
                    ...
                    <iframe name="event-box" frameborder="0" style="width:100%;border: none;height: 300px;"
                        src=""></iframe>
                </div>
    ...
    function viewdetail(id) {
        ...
        $('#calendarmodal').on('show.bs.modal', function(e) {
            ...
            $("#calendarmodal-detail").html(event.extendedProps
                .detail); // ข้อมูลเพิ่มเติมจะเรียกผ่าน extendedProps
        });
